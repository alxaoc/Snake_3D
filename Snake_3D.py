...
class Game(Ursina):
    def __int__(self):
        ...
        window.fullscreen_size = 1440, 900
        window.fullscreen = True
        AmbientLight(type='ambient', color=(0.5, 0.5, 0.5, 1)) # тип освищения окружающий
        DirectionalLight(type='directional', color=(0.5, 0.5, 0.5, 1), direction=(1, 1, 1)) # тип освещения напрвленный
        self.MAP_SIZE = 20
        self.new_game()
    ...
    def check_apple_eaten(self):
        if self.snake.segment_position[-1] == self.apple.position:
